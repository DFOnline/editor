...
import { SelectionBlock, SubActionBlock, BlockTag, SelectionValues, ParsedItem, Item, Variable, Text, Number as DFNumber, Location as DFLocation, Vector, Sound, GameValue, g_valSelection, Particle, Potion, Block, BracketType, Bracket, DataBlock, Target, SelectionBlocks, Argument, PlacedBlock} from "./template";
...
function tooltip(item : Argument, block : SelectionBlock | SubActionBlock ){ // tooltips (that are regenerated whenever you move your mouse over an item)
